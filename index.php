        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 mb-3 mb-md-0 col-md-4 order-1 order-md-2 text-center">
              <div >
            <a href="index.php" class="js-logo-clone"><img src="images/img9.png" alt="img" width="80px"></a>
              </div>
            </div>
            </div>
            </div>
      ...
      <div class="container">
        <div class="row align-items-center">
          ...
          <div class="col-md-12 col-lg-5 text-center pl-md-5">
            ...
            <p><a href="indexlogin.php" class="btn btn-sm btn-primary">Cotiza ahora</a></p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row align-items-center">
          <div class="col-md-12 col-lg-5 text-center pl-md-5">
            ...
            <p><a href="shop.php" class="btn btn-primary btn-sm">Ir al catálogo</a></p>
          </div>
          <div class="col-md-12 col-lg-7 mb-5">
