...
<html lang="en">
  <head>
    <title>Servicios-Frigaa Soluciones</title>
    <meta charset="utf-8">
  ...
  <div class="site-wrap">
    ...
    <div class="bg-light py-3">
      <div class="container">
        <div class="row">
          <div class="col-md-12 mb-0"><a href="index.php">Inicio</a> <span class="mx-2 mb-0">/</span> <strong class="text-black">Servicios</strong></div>
        </div>
      </div>
    </div>
